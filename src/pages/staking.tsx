    ...
    <div className="mx-auto max-w-7xl px-4 py-16">
      ...
      <section className="mb-16 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-300">
          Earn rewards by staking your Kwanzaa Coins. Choose from multiple staking tiers and start earning passive income today.
        </p>
      </section>
            ...
            <Card key={tier.name}>
              ...
              <CardContent>
                <div className="space-y-2">
                  <p><span className="font-medium">Lock Period:</span> {tier.duration}</p>
                  <p><span className="font-medium">APY:</span> <span className="text-green-600 dark:text-green-400">{tier.apy}</span></p>
                  <p><span className="font-medium">Min Amount:</span> {tier.minAmount} KWZ</p>
                </div>
              </CardContent>
            </Card>
          ))}
          ...
          <TabsContent value="stake">
            <div className="grid gap-8 md:grid-cols-2">
              ...
              <div className="rounded-lg bg-gray-50 p-6 dark:bg-gray-800/50">
                ...
                <div className="space-y-2">
                  <p><span className="font-medium">Annual Rewards:</span> {calculateRewards(stakeAmount, selectedTier)} KWZ</p>
                  <p><span className="font-medium">Monthly Rewards:</span> {(parseFloat(calculateRewards(stakeAmount, selectedTier)) / 12).toFixed(2)} KWZ</p>
